...
Ce module regroupe 23 fichier(s) source.
...
- **Fonctions principales** : __fspath__, __getattr__, __init__, _async_app, _param_cb, _reset_os_environ, _standard_os_environ, add_x_parachute, after_request_handler, after_request_signal, app, app_ctx, app_forbidden, backend_forbidden, backend_no
- **Dépendances** : __future__, _pytest, _pytest.monkeypatch, asyncio, blueprintapp, click, click.testing, codecs, collections.abc, concurrent, config_module_app, config_package_app
...
Module Python. Nombre de lignes: 96. Elements detectés: def _standard_os_environ, def _reset_os_environ, def app

**Fonctions** : _standard_os_environ, _reset_os_environ, app, app_ctx, req_ctx, client, test_apps, leak_detector, modules_tmp_path, modules_tmp_path_prefix, site_packages, purge_module, inner
**Dépendances** : os, sys, pytest, _pytest, flask, flask.globals
...
**Dépendances** : importlib.metadata, os, platform, ssl, sys, types, functools, pathlib, click, pytest, _pytest.monkeypatch, click.testing
