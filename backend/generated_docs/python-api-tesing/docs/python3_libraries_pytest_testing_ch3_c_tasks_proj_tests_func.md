# Module : python3_libraries/pytest_testing/ch3/c/tasks_proj/tests/func

6 fichier(s), 2 classe(s), 28 fonction(s).
...
Module Python. Nombre de lignes: 42. Elements detectés: def equivalent, def a_task, def test_add_a
