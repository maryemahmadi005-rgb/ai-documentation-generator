# Module : docs_src/app_testing/app_b_an_py310
...
- **Dépendances** : .main, fastapi, fastapi.testclient, pydantic, typing
...
Module Python. Nombre de lignes: 28. Elements detectés: class Item

**Classes** : Item
**Dépendances** : typing, fastapi, pydantic
